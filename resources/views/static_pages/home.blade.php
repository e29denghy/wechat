...
@section('content')
  ...
  <div class="container marketing">
    ...
    <div class="card-deck">
      <div class="card">
        <img class="rounded-circle align-self-center mr-3 mt-2" src="/static/image/com.png" alt="Generic placeholder image" width="140" height="140">
        ...
        <div class="card">
          <img class="rounded-circle  align-self-center mr-3 mt-2" src="/static/image/sun.png" alt="Generic placeholder image" width="140" height="140">
      ...
      <div class="card">
        <img class="rounded-circle  align-self-center mr-3 mt-2" src="/static/image/leader.png" alt="Generic placeholder image" width="140" height="140">
